...
// This is useful for creating rather high-poly planes. Commented out for now, because it unnecessarily makes the whole plugin depend
// on ProceduralMeshComponent and is not needed for anything anymore.
