...
{
	INTERNAL_DECLARE_SHADER_TYPE_COMMON(FAddDirLightShader_GPUSyncCS, Global, RAYMARCHER_API);
	DECLARE_EXPORTED_TYPE_LAYOUT(FAddDirLightShader_GPUSyncCS, RAYMARCHER_API, Virtual);
