...
public:
	...
	// Returns a bit number where all the bits between the window center and window width are ones. Also sample the TF texture
	// for each bit and set it to zero in case it should be zero.
	static FVector4 GetWindowingParamsBitNumber(FWindowingParameters WindowingParams, int EdgeBites, UTexture2D* TF);
