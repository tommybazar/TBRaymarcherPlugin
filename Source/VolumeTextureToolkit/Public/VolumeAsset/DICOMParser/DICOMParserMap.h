...
{
public:
	DICOMMapKey(doublebyte v1, doublebyte v2) : std::pair<doublebyte, doublebyte>(v1, v2)
	{
	}
};
...
{
public:
	DICOMMapValue() : std::pair<doublebyte, std::vector<DICOMCallback*>*>()
	{
	}

	DICOMMapValue(doublebyte v1, std::vector<DICOMCallback*>* v2) : std::pair<doublebyte, std::vector<DICOMCallback*>*>(v1, v2)
	{
	}
};
