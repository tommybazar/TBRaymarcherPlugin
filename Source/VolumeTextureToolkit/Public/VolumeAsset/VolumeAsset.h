...
///
/// Class wrapping most of the functionality in this plugin. Contains a FVolumeInfo containing loaded data and a transfer function
/// to get color from scalar values depending on windowing settings.
///
