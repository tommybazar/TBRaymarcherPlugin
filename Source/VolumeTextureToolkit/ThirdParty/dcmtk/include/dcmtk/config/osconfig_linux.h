...
#define DCM_DICT_DEFAULT_PATH "/usr/local/share/dcmtk-3.6.8/dicom.dic"
...
#define HAVE_PROTOTYPE_STRCASESTR 1
...
#define DEFAULT_CONFIGURATION_DIR "/usr/local/etc/dcmtk-3.6.8/"

/* Define to the default support data directory (used by some applications) */
#define DEFAULT_SUPPORT_DATA_DIR "/usr/local/share/dcmtk-3.6.8/"
